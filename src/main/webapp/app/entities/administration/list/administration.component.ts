...
import { EntityArrayResponseType, AdministrationService } from '../service/administration.service';
...
export class AdministrationComponent implements OnInit {
  ...
  trackId = (_index: number, item: IAdministration): number => this.administrationService.getAdministrationIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.administrations = this.refineData(dataFromBody);
  }
