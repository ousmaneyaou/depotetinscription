...
describe('Depot Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'depot', component: DepotComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.depots?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to depotService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getDepotIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDepotIdentifier).toHaveBeenCalledWith(entity);
