...
describe('Faculte routing resolve service', () => {
  ...
  let routingResolveService: FaculteRoutingResolveService;
  ...
  beforeEach(() => {
    ...
    routingResolveService = TestBed.inject(FaculteRoutingResolveService);
  ...
  describe('resolve', () => {
    it('should return IFaculte returned by find', () => {
      ...
      expect(resultFaculte).toEqual({ id: 123 });
    });
