...
import ng.campusnig.com.repository.PaiementRepository;
...
class PaiementResourceIT {
    ...
    private static final LocalDate DEFAULT_DATE_PAIE = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_DATE_PAIE = LocalDate.now(ZoneId.systemDefault());
    ...
    void getAllPaiements() throws Exception {
        ...
        restPaiementMockMvc
            ...
            .andExpect(jsonPath("$.[*].datePaie").value(hasItem(DEFAULT_DATE_PAIE.toString())))
    ...
    void getPaiement() throws Exception {
        ...
        restPaiementMockMvc
            ...
            .andExpect(jsonPath("$.datePaie").value(DEFAULT_DATE_PAIE.toString()))
